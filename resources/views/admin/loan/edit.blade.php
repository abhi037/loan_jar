                                ...
                                @if(auth()->id() == 1)
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1" name="manager_id">
                                                <option value="">-- Select Manager --</option>
                                                @foreach($managers as $manager)
                                                    <option value="{{ $manager->id }}" 
                                                        {{ (isset($manager) && $editrole->created_by == $manager->id) ? 'selected' : '' }}>
                                                        {{ $manager->name }}
                                                    </option>
                                                @endforeach
                                            </select> 
                                ...
                                @endif
                                        ...
                                        @endphp
                                                ...
                                                <select class="form-control select1" name="user_id">
                                                    ...
                                                    @foreach($users as $user)
                                                        <option value="{{ $user->id }}" {{ (isset($data) && $firstId == $user->id) ? 'selected' : '' }}>
                                            ...
                                            <div class="col-12 mt-3">
                                                ...
                                                <input type="text" class="form-control" id="loan_duration" name="loan_duration" value="{{ old('loan_duration', $editrole->loan_duration) }}" placeholder="e.g. 3M, 1Y" required>
                                   ...
                                   <div class="row mb-3 mt-3">
                                     ...
                                     <div class="col-sm-12 col-md-4">
                                        ...
                                        <p>Current Document: <a href="{{ asset('storage/' . $editrole->aadhar_card) }}" target="_blank">View</a></p>
                                        @endif
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        ...
                                        <p>Current Document: <a href="{{ asset('storage/' . $editrole->pan_card) }}" target="_blank">View</a></p>
                                        @endif
...
<script>
    ...
    window.addEventListener('load', calculateTotalWithInterest);

    // Also listen for changes in inputs
